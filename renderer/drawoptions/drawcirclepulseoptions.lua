---Description of DrawCirclePulseOptions table
---
...
---@field speed number #(float) Pulse animation speed. <br/>Default: `1.0`
---@field pulseCount number #(int) Pulse count. <br/>Default: `4`
Renderer.DrawCirclePulseOptions = {}
