...
---@field SolidAlpha number #(float) Alpha of the solid part of the circle. <br/> Default: `1.0`
---@field BlurIn number #(float) Inner blur distance in game units. Depending on your radius, increasing this number to certain amount will make this circle fully filled. <br/> Default: `10.0`
---@field BlurOut number #(float) Outer blur distance in game units. Increasing this number, combined with radius, will also increase the drawing's mesh size. If the mesh is too big it may cause overdraw and negatively impact FPS performance. <br/> Default: `10.0`
---@field BlurAlpha number #(float) Alpha of the blur part of the circle. <br/> Default: `0.25`
...
Renderer.DrawCircleGlowOptions = {}
